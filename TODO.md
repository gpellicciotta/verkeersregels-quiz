...
- [ ] T0052 [needs: T0047] [needs: T0049] [needs: T0050] Refactor app.js into composable, readable modules separating state, storage, and UI.
...
- [ ] T0053 [needs: T0048] [needs: T0051] [needs: T0045] [needs: T0038] Release version 3.2.0 with modular architecture, service worker auto-updates, configuration persistence, and localization.

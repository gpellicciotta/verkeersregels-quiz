...
- [~] T0054 [owner: @gemini] Add a non-color (icon with text "Juist" of "Fout") correct/wrong indicator at the top and center of the screen, to quiz answer options for colorblind accessibility. 

...
- `python C:\Dev-Projects\dev-guidelines\scripts\lint-taskfile.py tasks/T0024-series-f1-indication-signs.md`: 0 violations found.
- `python C:\Dev-Projects\dev-guidelines\scripts\lint-markdown.py TODO.md tasks/T0024-series-f1-indication-signs.md`: 0 violations found.

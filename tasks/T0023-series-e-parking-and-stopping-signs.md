...
- `python C:\Dev-Projects\dev-guidelines\scripts\lint-taskfile.py tasks/T0023-series-e-parking-and-stopping-signs.md`: 0 violations found.
- `python C:\Dev-Projects\dev-guidelines\scripts\lint-markdown.py TODO.md tasks/T0023-series-e-parking-and-stopping-signs.md`: 0 violations found.

...
class TestQuizData(unittest.TestCase):
    ...
    def test_total_question_count(self) -> None:
        """Validates that the question bank contains exactly 126 questions."""
        self.assertEqual(len(self.questions), 126, f"Expected exactly 126 questions, found {len(self.questions)}")

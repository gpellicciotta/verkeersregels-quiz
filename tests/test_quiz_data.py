...
class TestQuizData(unittest.TestCase):
    ...
    def test_total_question_count(self) -> None:
        """Validates that the question bank contains exactly 63 questions."""
        self.assertEqual(len(self.questions), 63, f"Expected exactly 63 questions, found {len(self.questions)}")

...
Overview of all documentation and specifications for Verkeersregels Quiz.
...
- [CHANGELOG](../CHANGELOG.md): Human-readable version history and release notes.
- [TODO](../TODO.md): Authoritative task coordination index across milestones.
- [LICENSE](../LICENSE.md): Software license terms (MIT).
